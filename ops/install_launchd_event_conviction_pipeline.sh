...
LABEL="${LABEL:-com.sharpoc.strategyresearch.event-conviction.pipeline}"
HOUR="${HOUR:-22}"
MINUTE="${MINUTE:-45}"
PLIST_DIR="$HOME/Library/LaunchAgents"
PLIST_PATH="$PLIST_DIR/$LABEL.plist"
SCRIPT_PATH="$REPO_ROOT/ops/run_mac_mini_event_conviction_pipeline.sh"
...
<dict>
  ...
  <string>$REPO_ROOT/ops/logs/event_conviction.launchd.stdout.log</string>
  <key>StandardErrorPath</key>
  <string>$REPO_ROOT/ops/logs/event_conviction.launchd.stderr.log</string>
  <key>RunAtLoad</key>
  <false/>
</dict>
</plist>
