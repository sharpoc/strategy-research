...
LABEL="${LABEL:-com.sharpoc.strategyresearch.rebound.pipeline}"
HOUR="${HOUR:-14}"
MINUTE="${MINUTE:-30}"
PLIST_DIR="$HOME/Library/LaunchAgents"
PLIST_PATH="$PLIST_DIR/$LABEL.plist"
SCRIPT_PATH="$REPO_ROOT/ops/run_mac_mini_rebound_pipeline.sh"
...
<dict>
  ...
  <string>$REPO_ROOT/ops/logs/rebound.launchd.stdout.log</string>
  <key>StandardErrorPath</key>
  <string>$REPO_ROOT/ops/logs/rebound.launchd.stderr.log</string>
  <key>RunAtLoad</key>
  <false/>
</dict>
</plist>
