...
LABEL="${LABEL:-com.sharpoc.strategyresearch.holder-chip.pipeline}"
HOUR="${HOUR:-22}"
MINUTE="${MINUTE:-15}"
PLIST_DIR="$HOME/Library/LaunchAgents"
PLIST_PATH="$PLIST_DIR/$LABEL.plist"
SCRIPT_PATH="$REPO_ROOT/ops/run_mac_mini_holder_chip_pipeline.sh"
...
<dict>
  ...
  <string>$REPO_ROOT/ops/logs/holder_chip.launchd.stdout.log</string>
  <key>StandardErrorPath</key>
  <string>$REPO_ROOT/ops/logs/holder_chip.launchd.stderr.log</string>
  <key>RunAtLoad</key>
  <false/>
</dict>
</plist>
